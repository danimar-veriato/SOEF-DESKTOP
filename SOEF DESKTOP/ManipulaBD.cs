...
namespace ORCAMENTOS_FOCKINK
{
    public class ManipulaBD
    {
        ...
        private static ManipulaBD objSqlServerCe = null;
        private static ManipulaBD objManipulaBD;
        ...
        /// <returns></returns>
        public static ManipulaBD GetInstance(string connString)
        {
            if (objManipulaBD == null)
            {
                objManipulaBD = new ManipulaBD();
            }
